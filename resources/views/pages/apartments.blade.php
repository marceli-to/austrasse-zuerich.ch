...
<x-layout.section>
  ...
  @for ($i = 1; $i <= 3; $i++)
    <x-layout.inner class="{{ $i == 1 ? 'mt-25 sm:mt-100' : 'mt-50 md:mt-125 lg:mt-150' }}" data-building-group="{{ $i }}">
      <x-layout.grid class="sm:!block md:!grid md:grid-cols-12 md:gap-24 lg:gap-32">
        ...
        <x-layout.span class="md:col-span-7 lg:col-span-7 2xl:col-span-6 md:-mt-80 lg:-mt-100 overflow-auto">
