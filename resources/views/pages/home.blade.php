...
<x-layout.section class="bg-white pt-35 xl:pt-70">
  <x-layout.inner>
    <div class="lg:max-w-3xl xl:max-w-4xl">
      ...
      <p>Die modernen und energetisch nachhaltigen Wohnungen können etappiert ab Mai 2024 bezogen werden.</p>
    </div>
  </x-layout.inner>
</x-layout.section>
  ...
  <x-layout.inner>
    <x-layout.grid class="grid grid-cols-12 gap-15">
      <x-layout.span class="!mb-0 col-span-6 md:col-span-4">
        <x-menu.card :route="'page.living'" :title="'Wohnen'" :image="'austrasse_zuerich_kueche_schlafzimmer_06-quadrat'" />
      </x-layout.span>
      <x-layout.span class="!mb-0 col-span-6 md:col-span-4">
