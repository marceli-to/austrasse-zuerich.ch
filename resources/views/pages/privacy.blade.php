...
<x-layout.section>
  <x-layout.inner>
    ...
    <p>Diese Liegenschaft steht im Eigentum eines Anlagegefässes, welches von der UBS Fund Management (Switzerland) AG verwaltet wird. Die entsprechende Datenschutzerklärung finden Sie hier: <a href="https://www.ubs.com/pn-ch" target="_blank" rel="noopener" title="Datenschutzerklärung UBS">www.ubs.com/pn-ch</a></p><p>Die Nutzung unserer Website ist in der Regel ohne Angabe personenbezogener Daten möglich. Soweit auf unseren Seiten personenbezogene Daten (beispielsweise Name, Anschrift oder E-Mail-Adressen) erhoben werden, erfolgt dies, soweit möglich, stets auf freiwilliger Basis. Diese Daten werden gemäss dieser Datenschutzerklärung teilweise an Dritte weitergegeben.</p><p>Wir weisen darauf hin, dass die Datenübertragung im Internet (z.B. bei der Kommunikation per E-Mail) Sicherheitslücken aufweisen kann. Ein lückenloser Schutz der Daten vor dem Zugriff durch Dritte ist nicht möglich.</p>
    
    <h2 class="text-base lg:text-md xl:text-lg mb-0">Cookies</h2>
    ...
    <h2 class="text-base lg:text-md xl:text-lg mb-0">Hosting Provider &amp; Server-LogFiles</h2>
    ...
    <h2 class="text-base lg:text-md xl:text-lg mb-0">Kontaktformular</h2>
    ...
    <h2 class="text-base lg:text-md xl:text-lg mb-0">Google Analytics</h2>
    ...
    <h2 class="text-base lg:text-md xl:text-lg mb-0">Google Maps</h2>
    <strong>Umfang, Zweck und Rechtsgrundlage der Datenverarbeitung</strong><br>
    ...
    <h2 class="text-base lg:text-md xl:text-lg mb-0">Recht auf Auskunft, Löschung, Sperrung</h2>
    ...
    <h2 class="text-base lg:text-md xl:text-lg mb-0">Verwendung von Adobe Fonts</h2>
